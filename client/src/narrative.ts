/**
 * Template-based narrative renderer: generates deterministic markdown narratives
 * from ScenarioResult objects without requiring an LLM call.
 *
 * This replaces the V2 LLM narration step, keeping all data processing local.
 */
import type { ScenarioResult, ScenarioImpact } from "./api";
